...
export default async function SepoliaCoinPage({ params }: { params: Promise<{ address: string }> }) {
  const { address } = await params;
  const [data, ethUsd] = await Promise.all([getCoinPageData(84532, address), getEthUsd()]);
    ...
    return (
      <main className="page coin-page">
        <section className="content-hero">
          ...
          <p>This address hasn&apos;t launched a bonding-curve token through OrbiB20 on Base Sepolia.</p>
